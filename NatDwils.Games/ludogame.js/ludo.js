...
play.addEventListener("click", function () {
  if (gi.value === "Player1") {
    var i;
    for (i = 0; i < 4; i++) {
      g[i].style.display = "Player1";
    }
    gdice[0].style.display = "Player1";
    gdice[1].style.display = "Player1";
    totalplayer -= 1;
    playername[2].innerHTML = "Player1";
    mplayername[1].innerHTML = "Player1";
  } else {
  ...
  if (ri.value === "Player2") {
    var i;
    for (i = 0; i < 4; i++) {
      r[i].style.display = "Player2";
    }
    rdice[0].style.display = "Player2";
    rdice[1].style.display = "Player2";
    totalplayer -= 1;
    playername[0].innerHTML = "Player2";
    mplayername[0].innerHTML = "Player2";
  } else {
  ...
  if (yi.value === "Player3") {
    var i;
    for (i = 0; i < 4; i++) {
      y[i].style.display = "Player3";
    }
    ydice[0].style.display = "Player3";
    ydice[1].style.display = "Player3";
    totalplayer -= 1;
    playername[3].innerHTML = "Player3";
    mplayername[3].innerHTML = "Player3";
  } else {
  ...
  if (bi.value === "Player4") {
    var i;
    for (i = 0; i < 4; i++) {
      b[i].style.display = "Player4";
    }
    bdice[0].style.display = "Player4";
    bdice[1].style.display = "Player4";
    totalplayer -= 1;
    playername[1].innerHTML = "Player4";
    mplayername[2].innerHTML = "Player4";
  } else {
  ...
  if (pp[0] === "r") {
    rdice[0].style.display = "Player4";
    rdice[1].style.display = "Player4";
  }
  if (pp[0] === "g") {
...
function motionOn(pno) {
  if (pno === 0) {
    var i;
    for (i = 0; i < 4; i++) {
      r[i].classList.add("animate__animated", "animate__bounce");
      y[i].classList.remove("animate__animated", "animate__bounce");
      g[i].classList.remove("animate__animated", "animate__bounce");
      b[i].classList.remove("animate__animated", "animate__bounce");
      r[i].style.zIndex = "+99";
      g[i].style.zIndex = "0";
      b[i].style.zIndex = "0";
      y[i].style.zIndex = "0";
    ...
    var i;
    for (i = 0; i < 4; i++) {
      g[i].classList.add("animate__animated", "animate__bounce");
      r[i].classList.remove("animate__animated", "animate__bounce");
      y[i].classList.remove("animate__animated", "animate__bounce");
      b[i].classList.remove("animate__animated", "animate__bounce");
    ...
    var i;
    for (i = 0; i < 4; i++) {
      y[i].classList.add("animate__animated", "animate__bounce");
      r[i].classList.remove("animate__animated", "animate__bounce");
      g[i].classList.remove("animate__animated", "animate__bounce");
      b[i].classList.remove("animate__animated", "animate__bounce");
    ...
    var i;
    for (i = 0; i < 4; i++) {
      b[i].classList.add("animate__animated", "animate__bounce");
      r[i].classList.remove("animate__animated", "animate__bounce");
      y[i].classList.remove("animate__animated", "animate__bounce");
      g[i].classList.remove("animate__animated", "animate__bounce");
  ...
  if (p === 0) {
    ...
    for (i = 0; i < 4; i++) {
      var blue =
        ...
        i +
        ')" class="rp material-icons b" style="z-index: 0;">sentiment_very_satisfied</span>';
      var green =
        '<span onclick="movegreen(this,' +
        i +
        ')" class="rp material-icons g" style="z-index: 0;">sentiment_very_satisfied</span>';

      var yellow =
        '<span onclick="moveyellow(this,' +
        i +
        ')" class="rp material-icons y" style="z-index: 0;">sentiment_very_satisfied</span>';
  ...
  if (p === 1) {
    ...
    for (i = 0; i < 4; i++) {
      ...
      var red =
        ...
        i +
        ')" class="rp material-icons r" style="z-index: 0;">sentiment_very_satisfied</span>';
      var yellow =
        '<span onclick="moveyellow(this,' +
        i +
        ')" class="rp material-icons y" style="z-index: 0;">sentiment_very_satisfied</span>';
    ...
    for (i = 0; i < step.length; i++) {
      if (rp[pno] === i) {
        step[redpath[rp[pno]]].innerHTML =
          "<span onclick='movered(this," +
          pno +
          ")' class='rp material-icons r'>sentiment_very_satisfied</span>" +
          prevpl;
      } else {
        obj.remove();
      }
    ...
    for (i = 0; i < step.length; i++) {
      if (gp[pno] === i) {
        step[greenpath[gp[pno]]].innerHTML =
          "<span onclick='movegreen(this," +
          pno +
          ")' class='rp material-icons g'>sentiment_very_satisfied</span>" +
          prevpl;
      } else {
        obj.remove();
      }
    ...
    for (i = 0; i < step.length; i++) {
      if (bp[pno] === i) {
        step[bluepath[bp[pno]]].innerHTML =
          "<span onclick='moveblue(this," +
          pno +
          ")' class='rp material-icons b'>sentiment_very_satisfied</span>" +
          prevpl;
      } else {
        obj.remove();
      }
    ...
    for (i = 0; i < step.length; i++) {
      if (yp[pno] === i) {
        step[yellowpath[yp[pno]]].innerHTML =
          "<span onclick='moveyellow(this," +
          pno +
          ")' class='rp material-icons y'>sentiment_very_satisfied</span>" +
          prevpl;
      } else {
        obj.remove();
      }
